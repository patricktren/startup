...
## Design
![Screenshot of how GPT-Notes might look when finished; it shows a user logged in and their project, the whiteboard they're using, a query and its response from Chat GPT, and a note the user made][https://github.com/patricktren/startup/blob/main/gpt-notes_design.PNG]